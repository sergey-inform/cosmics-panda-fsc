...
THRESHOLD = 1 * 1000  # filter values less than threshold
COL_IDX = 3  # which column contains values, starting from 0
...
mpl_str = u"{:.2f} a {:.2f}".format(*result[1])
sigma_str = u"{:.2f} a {:.2f}".format(*result[2])
